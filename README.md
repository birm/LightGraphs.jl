...
![Build Status](https://github.com/JuliaGraphs/LightGraphs.jl/actions/workflows/ci-nightly.yml/badge.svg?branch=stable)hub/JuliaGraphs/LightGraphs.jl/coverage.svg?branch=master)](http://codecov.io/github/JuliaGraphs/LightGraphs.jl?branch=master)
